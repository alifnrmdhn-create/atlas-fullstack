...
export default function HomeView() {
  ...
  // Onboarding tour 'pdca-orientation' DISABLED 2026-05-26 — narasi PDCA
  // (Plan→Do→Check→Act) tidak lagi match sidebar yang sekarang intent-based
  // (My Work / Portfolio & Performance / Account). Re-enable: tambah balik
  // import + panggil useOnboardingTour('pdca-orientation', { trigger: ... }),
  // dan rewrite TOURS['pdca-orientation'] di lib/onboardingTours.ts dengan
  // narrative + selectors yang sesuai struktur baru.
