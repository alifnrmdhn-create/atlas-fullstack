 ...
 *
 * Diekstrak dari OrganizationController::buildProgramSummary (audit 2026-06-10
 * Task 2.4 — dulu 584 baris + 9 helper privat inline di controller, metode
 * terpanjang di codebase). Murni komputasi User → array (tanpa state request)
 * sehingga cacheable; wrapper cache 3 menit tetap di controller (concern HTTP).
 * Kontrak shape dikunci OrgProgramSummaryTest; ekuivalensi payload diverifikasi
 * snapshot-diff data riil saat ekstraksi.
 */
class OrgSummaryService
{
    /**
